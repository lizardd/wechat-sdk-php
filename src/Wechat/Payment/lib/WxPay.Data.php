...
//require_once config_path('/wechat/WxPay.Config.php');
...
class WxPayDataBase
{
	 ...
	 */
	public function setWxPayConfig(array $wxPayConfig)
	{
	 ...
	 */
	public function setWxPayApi(\WxPayApi $wxPayApi)
	{
		$this->wxPayApi = $wxPayApi;
		$this->wxPayConfig =$wxPayApi->getWxPayConfig();
	}
...
class WxPayResults extends WxPayDataBase
{
	 ...
	 * @return array values
     */
	public static function Init($xml,$wxPayConfig)
	{	
		$obj = new self();
		$obj->setWxPayConfig($wxPayConfig);
		$obj->FromXml($xml);
		//fix bug 2015-06-29
